...
namespace TaskNinja.Migrations
{
    ...
    [Migration("20240128171300_testChangeIdType")]
    partial class testChangeIdType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskNinja.Models.TeamInvite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TaskNinja.Models.TeamInvite", b =>
                {
                    b.HasOne("TaskNinja.Models.User", "Recipient")
                        .WithOne()
                        .HasForeignKey("TaskNinja.Models.TeamInvite", "RecipientId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TaskNinja.Models.User", "Sender")
                        .WithOne()
                        .HasForeignKey("TaskNinja.Models.TeamInvite", "SenderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TaskNinja.Models.Team", "Team")
                        .WithOne("TeamInvite")
                        .HasForeignKey("TaskNinja.Models.TeamInvite", "TeamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
